programa
{
	...
	inteiro arma_gustavo=0, reias_gustavo=25, arma_zanette=0, reias_zanette=15, arma_luigu=0, reias_luigu=18, reias_antonio=0
				...
				se(opcao=="1"){
					...
					limpa()
						...
						se(opcao2=="s" ou opcao2=="S"){
							...
							reias_luigu+=50 reias_zanette+=50 reias_gustavo+=50 reias_antonio+=50
							escreva("Depois da épica batalha,")u.aguarde(1500) escreva(" o grupo avança...")u.aguarde(3000)
							escreva("Todo mundo ganhou 50 reias!!!")u.aguarde(2500)
